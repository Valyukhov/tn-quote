const chapter = `\\id 2TI unfoldingWord® Greek New Testament
\\usfm 3.0
\\ide UTF-8
\\h 2 Timothy
...
\\v 16
δῴη ἔλεος ὁ Κύριος τῷ Ὀνησιφόρου οἴκῳ, ὅτι πολλάκις με ἀνέψυξεν, καὶ τὴν ἅλυσίν μου οὐκ ἐπησχύνθη;
\\v 17
...
\\v 3
συνκακοπάθησον ὡς καλὸς στρατιώτης Ἰησοῦ Χριστοῦ.
\\v 4
...
\\v 16
ἐν τῇ πρώτῃ μου ἀπολογίᾳ, οὐδείς μοι παρεγένετο, ἀλλὰ πάντες με ἐνκατέλιπον; μὴ αὐτοῖς λογισθείη.
\\v 17
...
\\v 21
σπούδασον πρὸ χειμῶνος ἐλθεῖν. ἀσπάζεταί σε Εὔβουλος, καὶ Πούδης, καὶ Λίνος, καὶ Κλαυδία, καὶ οἱ ἀδελφοὶ.
\\v 22

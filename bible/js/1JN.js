const chapter = `\\id 1JN unfoldingWord® Greek New Testament
\\usfm 3.0
\\ide UTF-8
\\h 1 John
...
\\p ὁ Θεὸς ἀγάπη ἐστίν, καὶ ὁ μένων ἐν τῇ ἀγάπῃ, ἐν τῷ Θεῷ μένει, καὶ ὁ Θεὸς ἐν αὐτῷ μένει.
\\v 17
...
\\v 15
καὶ ἐὰν οἴδαμεν ὅτι ἀκούει ἡμῶν, ὃ ἂν αἰτώμεθα, οἴδαμεν ὅτι ἔχομεν τὰ αἰτήματα ἃ ᾐτήκαμεν ἀπ’ αὐτοῦ.
\\v 16
